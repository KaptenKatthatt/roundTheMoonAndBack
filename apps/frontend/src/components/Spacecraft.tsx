...
const _scAhead = new THREE.Vector3();
...
export function Spacecraft() {
  ...
  useFrame(() => {
    ...
    const pos = getPositionAt(currentTime, _scPos);
    ...
    const ahead = getPositionAt(currentTime + 60_000, _scAhead);
    if (ahead.distanceTo(pos) > 0.001) {
      _forward.subVectors(ahead, pos).normalize();
