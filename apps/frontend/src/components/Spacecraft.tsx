...
// ⚡ Bolt: Pre-allocate static scratchpad vectors for useFrame to prevent object creation overhead
...
export function Spacecraft() {
  ...
  useFrame(() => {
    ...
    if (_ahead.distanceTo(_scPos) > 0.001) {
      _forward.subVectors(_ahead, _scPos).normalize();
